                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex">
                                ...
                                <div class="ml-1"><input id="f<?php echo $tid; ?>" type="text" class="form-control text-right"
                                        value="<?php echo $welfare; ?>" /><label class=" text-small pl-2">Welfare</label></div>
                                <div class="ml-1"><input id="g<?php echo $tid; ?>" type="text" class="form-control text-right"
                                        value="<?php echo $retire; ?>" /><label class=" text-small pl-2">Retirement</label>
                                </div>
                                ...
                                <div class="ml-1"><input id="yo<?php echo $tid; ?>" type="text"
                                        class="form-control text-right full-width" value="<?php ?>" />
                                    <label class=" text-small pl-2"></label>
                                </div>
                        ...
                        <div class="row">
                            <div class="row  mt-4">
                                ...
                                if ($edit_lock == 0) {
                                    if ($found == 0) { ?>
                                        <button class="btn btn-inverse-success btn-fw p-2 " id="btt<?php echo $tid; ?>"
                                            onclick="payoff(<?php echo $tid; ?>, <?php echo $iiid; ?>);">Payoff</button>
                                    <?php } else { ?>
                                        <button class="btn btn-inverse-danger btn-fw  p-2" id="btt<?php echo $tid; ?>"
                                            onclick="payoff(<?php echo $tid; ?>, <?php echo $iiid; ?>);">Refund
                                            Amount</button>
                                    <?php }

                                    ?>
                                    <button class="btn btn-inverse-primary btn-fw  ml-4 mr-3  p-2"
                                        onclick="calc(<?php echo $tid; ?>);">Re
                                        Calc</button>

                                <?php } ?>
                                <div class=" text-white" style="border:1px solid white; border-radius:3px; padding: 5px 20px;"
