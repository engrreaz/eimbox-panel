        ...
        if ($result0->num_rows > 0) {
            while ($row0 = $result0->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td style="padding : 3px 10px; border:1px solid gray;">
                        <div class="ooo"><?php echo date('d/m/Y', strtotime($prdate)); ?></div>
                    </td>
...
<script>
    ...
    function go() {
        ...
        var dateto = document.getElementById('dateto').value;
        var collector = document.getElementById('collector').value;
        window.location.href = 'search-receipt.php?sec=' + sec + '&cls=' + cls + '&year=' + year + '&datefrom=' + datefrom + '&dateto=' + dateto + '&collector=' + collector;
    }
