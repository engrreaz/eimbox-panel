...
<h3 class="d-print-none">Houan Resource Persons (<?php echo $hrlist; ?>)</h3>
<p class="d-print-none">
    <code>Human Resource <i class="mdi mdi-arrow-right"></i> <?php echo $hrlist; ?> </code>
</p>

<div class="row d-print-none">
    <a href="hr-list.php?<?php echo $hrlist; ?>&sl=School" class="btn">
        <button class="btn btn-inverse-<?php echo $btnt; ?> p-2">School</button>
    </a>
    <a href="hr-list.php?<?php echo $hrlist; ?>&sl=College" class="btn">
        <button class="btn btn-inverse-<?php echo $btns; ?> p-2">College</button>
    </a>
</div>
...
<table class="table table-bordered table-striped " style=" border:1px solid gray !important; border-collapse:collapse;"
    ...
    <tbody>
        ...
        <?php
        $sql0 = "SELECT * FROM teacher where sccode='$sccode' and slots='$slot' and ranks $sign 30 order by sl, ranks";
            ...
            while ($row0 = $result0->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td style="padding : 3px 10px; border:1px solid gray;">
                        ...
                        <div class="ooo"><?php echo $tnamee; ?></div>
                        <div class="ooo"><?php echo $tnameb; ?></div>
                    </td>
                    <td style="padding : 3px 10px; border:1px solid gray;">
                        <?php echo $ranks; ?>
                    </td>
