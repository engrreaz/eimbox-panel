            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <br><span class=" text-small"><i class="mdi mdi-checkbox-blank-circle mdi-12px"></i> <?php echo $mydata['fprof'];?>, <i
                                class="mdi mdi-cellphone-basic mdi-18px"></i> <?php echo $mydata['fmobile'];?>, <i
                                class="mdi mdi-account-card-details "></i> <?php echo $mydata['fnid'];?>, </span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2"></div>
                    ...
                    <div class="col-md-8">
                        ...
                        <br><span class=" text-small"><i class="mdi mdi-checkbox-blank-circle mdi-12px"></i> <?php echo $mydata['mprof'];?>, <i
                                class="mdi mdi-cellphone-basic mdi-18px"></i> <?php echo $mydata['mmobile'];?>, <i
                                class="mdi mdi-account-card-details "></i> <?php echo $mydata['mnid'];?>, </span>
                    </div>
                </div>
