...
if ($result0->num_rows > 0) {
    ...
    $query33 = "insert into stmark
            (id, sessionyear, sccode, exam, classname, sectionname, subject, fullmark, stid, markobt, gp, gl,  entryby, entrydate, subj, obj, pra, ca, sub_final, obj_final, pra_final)
            values 	(NULL, '$sessionyear', '$sccode', '$exam', '$cn', '$secname', '$subname', '$fullmark', '$iii','$yn','$gp','$gl', '$usr','$etdt', '$subj', '$obj', '$pra', '$ca'	, '$sub_final', '$obj_final', '$pra_final')";
