...
/*paycode = '$paycode' ,
            ...
            arrea ='$arrea', welfare ='$welfare', retire='$retire', netamtgovt='$net',
            salary='$salary', mobilevata='$mpa', travel ='$travel', medical2 ='$ma2', exam='$exam', festival='$fest', pf='$pf', net2='$net2',
