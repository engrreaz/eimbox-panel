          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="students">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="students-payment.php"><i
                class="mdi mdi-coin"></i>&nbsp; Fees & Payments</a></li>
                <li class="nav-item"> <a class="nav-link" href="payment-receipt.php"><i
                class="mdi mdi-printer"></i>&nbsp; Print Receipt</a></li>
                <li class="nav-item"> <a class="nav-link" href="payment-receipt.php">Search Receipt</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
